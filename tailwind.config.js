      ...
      typography: ({ theme }) => ({
        DEFAULT: {
          css: {
            ...
            "--tw-prose-links": theme("colors.neutral.700 / 1"),
            ...
            "--tw-prose-code-bg": theme("colors.neutral.200 / 1"),
            ...
            a: {
              ...
              textDecorationColor: theme("colors.primary.400 / 1"),
              fontWeight: "600",
              "&:hover": {
                color: theme("colors.neutral.700 / 1"),
